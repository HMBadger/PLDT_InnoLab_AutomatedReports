        ...
        <form method="post">
          <div class="container form-group" >
            <div class="row">
              ...
              <div class="col-xs-11">
                <input class="btn btn-primary" style="width:15%!important;" type="submit" name="btnSubmit" id="btnIDSubmit" value="SAVE">
              </div>
            </div>
          </div>
        <?php
              ...
              if(mysqli_num_rows($query) > 0)
						{
							...
							$query = mysqli_query($conn, $sql);
									if($query)
									{
										$strMessage = "Activity Successfully Edited: $actName";
