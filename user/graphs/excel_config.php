...
while($mrow = mysqli_fetch_assoc($res)) {
	$objPHPExcel->getActiveSheet()->setCellValue("A2" .$row, $mrow['ReportDate']);
	$objPHPExcel->getActiveSheet()->setCellValue("B2" . $row, $mrow['LocationName']);
	$objPHPExcel->getActiveSheet()->setCellValue("C2" . $row, $mrow['GroupName']);
	$objPHPExcel->getActiveSheet()->setCellValue("D2" . $row, $mrow['CategoryName']);
	$objPHPExcel->getActiveSheet()->setCellValue("E2" . $row, $mrow['ReportClient']);
	$objPHPExcel->getActiveSheet()->setCellValue("F2" . $row, $mrow['ReportPerson']);
	$objPHPExcel->getActiveSheet()->setCellValue("G2" . $row, $mrow['ActivityName']);
	$row++;	
}
